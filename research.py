...
def print_data(c, h, service, vuln_queries, patch_queries, query):
    ...
    result_patch = get_categories(h, patch_queries)
...
#print_data(c, h, "Solr Admin", vulnerable_solr_vers_queries, patched_solr_vers_queries, "services.http.response.html_title=`Solr Admin`")
...
#print_data(c, h, "Rundeck", vulnerable_pd_vers_queries, patched_pd_vers_queries, "services.http.response.html_title: `Rundeck`")
...
print_data(c, h, "Neo4j", vulnerable_neo4j_vers_queries, patched_neo4j_vers_queries, "services.http.response.body: `neo4j`")
